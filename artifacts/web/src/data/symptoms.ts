...
export const symptoms: Symptom[] = [
  {
    ...
    description: "Most childhood fevers come from ordinary viruses. What counts as a fever, which fevers mean 911 or an emergency room, and why a fever in a baby under 3 months means calling us tonight.",
    intro: [
      ...
      "Call 911 as well if your child is struggling for each breath and can barely speak or cry, or if purple or blood-colored spots appear on the skin. An emergency room is the right place for a stiff neck or for a seizure during the fever. Go as well if your baby is under a year old and the soft spot on the head bulges or swells. Take your child to an emergency room too if they are hard to wake, are not alert when awake, or act or talk confused. Any fever in a baby under 3 months old, which is 12 weeks, means calling us at any hour, because at that age we check rather than wait. Do not give a baby under 3 months any fever medicine before we have seen them. The When To Call tab below lists the fevers that need a call within a day, and the Care Advice tab covers comfort and dosing.",
    ],
  },
  {
    slug: "fever-under-1",
