...
export const symptoms: Symptom[] = [
  {
    ...
    description: "Most childhood fevers come from ordinary viruses. What counts as a fever, which fevers mean 911 or an emergency room, and why any fever under 3 months means calling us tonight.",
    intro: [
  ...
  },
  {
    ...
    intro: [
      ...
      "Go straight to an emergency room if your child's vomit is green, meaning the green of bile rather than the yellow of stomach juice. Green vomit is the rare exception. Everything else starts at home, with changes to food and a calmer routine, and the Care Advice tab below has them. Call us before you start a stool softener, so that we can go over which one suits your child and how much to give. A breastfed baby over a month old can go four to seven days between stools without being constipated, as long as those stools stay soft and painless. That exception is about how often a stool comes and nothing else. The When To Call tab below covers belly pain, bleeding and constipation that will not shift.",
    ],
  },
  {
    slug: "asthma-attack",
